...
<?php
	$slideset = array("another_commander-20160609-oolite_005b.jpg", 
		"another_commander-20160816-kraitYo03b.jpg", 
	...
	print ("\"/images/slideshow/$firstslide");

	$slideset = array_slice($slideset,1,8);
	foreach ($slideset as $image)
	{
		print ("\", \n");
		print ("\"/images/slideshow/$image");
	}
	print ("\"]; \n");
?>
			...
			function showNextSlide(n) {
				...
				if (currentImageCounter == maxIndex) {currentImageCounter = 1}    
