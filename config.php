...
// stable release)
define("OOLITE_DEFAULT_OXZ_OOLITE_VERSION","1.84");

function oolite_versions() {
	return array("1.79","1.80","1.81","1.82","1.83","1.84","1.85","1.86");
}

function oolite_max_versions() {
	// assume that more than 99 point releases of a named release are unlikely
	$array = array_merge(oolite_versions(),array("1.79.99","1.80.99","1.81.99","1.82.99","1.83.99","1.84.99","1.85.99","1.86.99"));
	sort($array);
